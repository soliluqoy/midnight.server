...
# Development invocations use MIDNIGHT_SERVER_EXPERIMENTAL=1 by default. Pass --stable to use
...
export MIDNIGHT_SERVER_EXPERIMENTAL="${MIDNIGHT_SERVER_EXPERIMENTAL:-1}"
