...
export const ENV_SERVER_DIR = "MIDNIGHT_SERVER_SERVER_DIR";
export const ENV_SERVER_ID = "MIDNIGHT_SERVER_SERVER_ID";
...
export interface StartServerOptions {
	/** Server profile and socket directory. Defaults to MIDNIGHT_SERVER_SERVER_DIR or ~/.pi/server. */
	readonly directory?: string;
	/** Logical service ID. Defaults to MIDNIGHT_SERVER_SERVER_ID or the directory's default-server-id. */
	readonly serverId?: ServerId;
