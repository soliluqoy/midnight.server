> midnight.server can create prompt templates. Ask it to build one for your workflow.
...
midnight.server loads prompt templates from:

- Global: `~/.midnight.server/agent/prompts/*.md`
- Project: `.midnight.server/prompts/*.md` (only after the project is trusted)
